...
silent! normal! zE
let &fdl = &fdl
let s:l = 16 - ((14 * winheight(0) + 33) / 67)
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 115 + 141) / 283)
exe 'vert 2resize ' . ((&columns * 167 + 141) / 283)
argglobal
balt gui.c
let s:cpo_save=&cpo
set cpo&vim
...
silent! normal! zE
let &fdl = &fdl
let s:l = 24 - ((23 * winheight(0) + 33) / 67)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 24
...
silent! normal! zE
let &fdl = &fdl
let s:l = 94 - ((66 * winheight(0) + 33) / 67)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 94
...
silent! normal! zE
let &fdl = &fdl
let s:l = 37 - ((24 * winheight(0) + 33) / 67)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 37
